...
-- Création d'une table (infos enregistrés, pas de temps réel derrière)
DROP TABLE IF EXISTS tbdemo;
CREATE TABLE tbdemo
SELECT
	CLI_NOM,
	MIN(CMDE_PRIX_UNITAIRE) AS PRIX_MINI,
...
-- Création d'une vue (VIEW, temps réel OK puisqu'il recalcule tout)
DROP VIEW IF EXISTS vwdemo;
